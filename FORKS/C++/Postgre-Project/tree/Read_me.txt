...
Datafiles: 
    NHTS Data:  HHV2PUB.CSV                 Households 
    ...
    EIA Data:   EIA_CO2_Electric_2014       CO2 emmisions from electric sources
                EIA_CO2_Transportation_2014 CO2 emissions from transportation sources
                EIA_MkWh_2014               CO2 emissions in MkWh units
...
To load the database 'postgres' (create tables and load values into them), you must run the script 'CreatAndInsert.sh'. In order to perform the queries run the executable Query_Database.out.
    ...
    II.a) Necessary Configurations to Start
	...
	II.b) Necessary Files to run Insertion and Creation:
	...
	II.c) Necessary Files to run Queries:
