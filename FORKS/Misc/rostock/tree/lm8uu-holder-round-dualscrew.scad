...
// LM8UU/rod dimensions, Bearings are 15.00mm
	...
	difference()
	{
		union()
		{
			...
			translate([0,0,(LM8UU_dia/2)+body_wall_thickness])		
				rotate([90,0,0])
					cylinder(r=(LM8UU_dia/2) + body_wall_thickness+1, h=LM8UU_length, center=true);
...
//				cylinder(r=LM8UU_dia/2, h=LM8UU_length+1, center=true);
		...
		translate([
			...
			cube([gap_width,
				  LM8UU_length+2,
				  (LM8UU_dia/2)+screw_bushing_space+(screw_thread_dia/2)+(nut_dia/2)+nut_surround_thickness+1]);
